...
namespace orion {
    ...
    namespace field {
        ...
        {
            static_assert(std::is_base_of_v<WorldObject, T>, "T must inherit from WorldObject to have getTypeInfo");
        ...
        {
            static_assert(std::is_base_of_v<WorldObject, U>, "U must inherit from WorldObject to use isInstanceOf");
            ...
            {
                if (instance_type_info == class_type_info)
                    return true;
        ...
        R (*virtualFunctionAddress(R (T::*func)(Args...)))(Args...)
        {
            struct member_function {
                u64 ptr;
                s64 adj;
            };
            static_assert(sizeof(member_function) == sizeof(func));
            member_function* mf = reinterpret_cast<member_function*>(&func);
            return reinterpret_cast<R (*)(Args...)>(T::sVTable[mf->ptr / sizeof(void*)]);
        }
        ...
        struct EncountObject : PokemonModel {
            ...
            u8 unk13[0xb32 - 0x8a8 - 0x58];
            bool requestedDeletion;
            u8 unk14[0xd48 - 0xb33];
            u64 spawnerHash;
            u64 unk15;
            bool isFollowing;
            u8 unk16[0xd80 - 0xd59];
            // ...
