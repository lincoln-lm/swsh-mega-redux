...
namespace personal_info {
    ...
    inline const MegaEvolutionInfo cMegaEvolutionInfo[] = {
        ...
        { Species::Scolipede, 1, 60, 140, 149, 75, 99, 62, Type::Bug, Type::Poison, Ability::ShellArmor },
        { Species::Scrafty, 1, 65, 130, 135, 55, 135, 68, Type::Dark, Type::Fighting, Ability::Intimidate },
